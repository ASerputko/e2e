...
var webdriver = require('selenium-webdriver'), chrome = require('selenium-webdriver/chrome'), firefox = require('selenium-webdriver/firefox'), ie = require('selenium-webdriver/ie');
    ...
    Direct.prototype.setupEnv = function () {
        switch (this.config_.capabilities.browserName) {
            ...
            case 'firefox':
                ...
                break;
            case 'ie':
                logger.info('Using IEDriver directly...');
                break;
            default:
    ...
    Direct.prototype.getNewDriver = function () {
        ...
        switch (this.config_.capabilities.browserName) {
            ...
            case 'ie':
                ...
                driver = new ie.Driver(this.config_.capabilities);
                break;
            default:
                throw new Error('browserName ' + this.config_.capabilities.browserName +
                    'is not supported with directConnect.');
